  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-visual"><div className="hero-glow" /><a className="nav-cta hero-visual-cta" href="#start"><span className="nav-cta-price"><span>$2.99</span><span className="nav-cta-once"> once</span></span><span className="nav-cta-label">Get started</span><span className="nav-cta-arrow">↗</span></a><Phone src="/screens-clean/log-road-cycling.png" alt="Gnistre home screen for logging an activity" /></div>
      </section>

      <section className="feature-section" id="how"><div className="core-lower standalone-feature"><div className="feature-copy"><div className="section-kicker">Optional distance. Private by design.</div><h2>Distance when you want it.<br /><em>Privacy by default.</em></h2><p className="statement-lede">Your progress doesn&apos;t need an audience.</p><p>Start a session, let Gnistre measure distance, and keep moving. No maps. No route history.</p><p className="noise-note">Your location stays on your phone.<br />No tracking. No sharing. No audience.</p><div className="feature-points"><article><span>01</span><div><h3>Simple by design</h3><p>Start in real time or log it afterwards. Choose what you did, add a little detail, and save.</p></div></article><article><span>02</span><div><h3>Distance when useful</h3><p>Optional GPS measurement for walks, runs, rides and more.</p></div></article><article><span>03</span><div><h3>Private by default</h3><p>Your activities are yours. No feeds, followers or public scoreboard.</p></div></article></div></div><div className="feature-phones"><Phone src="/screens-clean/edit-distance.png" alt="Gnistre edit entry showing running distance and average pace" className="phone-small phone-back" /><Phone src="/screens-clean/stopwatch-gps.png" alt="Gnistre stopwatch with optional distance tracking ready to start" className="phone-small phone-front phone-gps" /></div></div></section>

      <section className="everyone-section" id="everyone"><div className="everyone-copy"><div className="section-kicker">For every age. Every kind of movement.</div><h2>Not just workouts.<br /><em>Not just athletes.</em></h2><p>Gnistre is for school days, training days, creative days and everything in between — whether you&apos;re just getting started or already on your way.</p><a className="text-link" href="#start">Find your starting point <span>↗</span></a></div><div className="activity-collage"><Phone src="/screens-clean/activities-creative-academic.png" alt="Gnistre creative and academic activity categories" className="collage-phone collage-back" /><Phone src="/screens-clean/activities-sports.png" alt="Gnistre sports activity list" className="collage-phone collage-front" /></div></section>
