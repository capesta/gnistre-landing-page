...
export default function Home() {
  return (
    <main>
      ...
      <section className="feature-section" id="how"><div className="core-lower standalone-feature"><div className="feature-copy"><div className="section-kicker">Core over content.</div><h2>Designed to get out of your way.</h2><p className="statement-lede">Your progress doesn&apos;t need an audience.</p><p className="noise-note"><strong>Optional pace and distance tracking.</strong><span>No maps. No route history.</span><span>No data harvesting.</span></p><div className="feature-points"><article><span>01</span><div><h3>Simple by design</h3><p>Start now or log it later. Choose what you did, add a detail if you want, and save.</p></div></article><article><span>02</span><div><h3>Private by default</h3><p>Your activities are yours. No feeds, followers or public scoreboard.</p></div></article><article><span>03</span><div><h3>More depth when you want it</h3><p>See pace splits, focus breakdowns and progress over time — without the noise.</p></div></article></div><div className="feature-glimpse"><img src="screens-clean/stats-1.png" alt="Gnistre activity trend chart showing progress over time" /><img src="screens-clean/stats-2.png" alt="Gnistre focus breakdown showing time spent across activity details" /></div></div><div className="feature-phones"><Phone src="/screens-clean/edit-distance-2026-08-28-clean.png" alt="Gnistre edit entry showing running distance and average pace" className="phone-small phone-back" /><Phone src="/screens-clean/stopwatch-gps.png" alt="Gnistre stopwatch with optional distance tracking ready to start" className="phone-small phone-front phone-gps" /></div></div></section>

      <section className="everyone-section" id="everyone"><div className="everyone-copy"><div className="section-kicker">For every age. Every kind of movement.</div><h2>Not just workouts.<br /><em>Not just athletes.</em></h2><p>Simple, fast and private activity tracking for all ages. Whether you want to keep track of schoolwork or gym sessions, baseball or chess, GNISTRE has you covered.</p><p>Start in real time or log it later. Choose Activity Focus for a closer look at your efforts. Track distance, pace and splits if you want — or keep it simple. Add more detail in the activity log whenever you need it.</p><p className="everyone-price"><strong>One-time purchase: $2.99.</strong><br />No subscriptions. No ads. We don&apos;t sell your data.</p><a className="text-link" href="#start">Find your starting point <span>↗</span></a></div><div className="activity-collage"><Phone src="/screens-clean/activities-creative-academic.png" alt="Gnistre creative and academic activity categories" className="collage-phone collage-back" /><Phone src="/screens-clean/activities-sports.png" alt="Gnistre sports activity list" className="collage-phone collage-front" /></div></section>
